// todo refactor these to use crates from snark-verifier
use crate::{
    accumulation::{
        protostar::{
    ...
    // replace this with simple plonk backend
    backend::{
...
// todo replace these with appropriate fn in halo2-lib (halo2-ecc) - ECC Chip
...
// todo replace these from snark-verifier/src/util/transcript.rs
// also look into poseidon transcript in the above file ^^ 
...
// might need to use this. todo look into the RecursionCircuit here - snark-verifier/examples/recursion.rs
#[derive(Debug)]
...
// todo look into CircuitExt defined here snark-verifier-sdk/src/lib.rs
